    ...
    <div className="relative min-h-screen flex flex-col items-center justify-center p-4 overflow-hidden font-sans">
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-slate-600 dark:text-slate-400 mt-2">Create your neural workspace</p>
        </div>
        ...
        <p className="text-center mt-8 text-slate-600 dark:text-slate-400 text-sm">
          ...
          <Link className="text-[#7f0df2] font-bold hover:underline underline-offset-4" href="/login">Sign in</Link>
        </p>
      </div>
    </div>
  );
